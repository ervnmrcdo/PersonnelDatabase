...
export default function Form44Editor({ publicationId }: FormEditorProps) {
  ...
  const config = useMemo(() => ({
    document: {
      ...
      key: documentKey,
      title: "4.4-template",
      url: `http://host.docker.internal:3000/api/generate-form/ipa-44?publicationId=${publicationId}`,
    },
    documentType: "pdf",
    editorConfig: {
      mode: "edit",
