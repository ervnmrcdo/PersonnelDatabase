...
export default function Form41Editor({ publicationId }: FormEditorProps) {
    ...
    const config = useMemo(() => ({
        document: {
            ...
            key: documentKey,
            title: "4.1-template",
            url: `http://host.docker.internal:3000/api/generate-form/ipa-41?publicationId=${publicationId}`,
        },
        documentType: "pdf",
        editorConfig: {
            mode: "edit",
